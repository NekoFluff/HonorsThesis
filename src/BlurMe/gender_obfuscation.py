...
###########################################################
# Recreate the exact same model as generated from 'gender_inference_NN.py'.
...
#####################################################################
# Retrieve user 
user1 = dataset.user_item_matrix[0]
user_gender = dataset.user_info[0]['gender'] # 0 is male, 1 is female
...
for user_index, user_vector in enumerate(test_ratings):
    ...
    new_user_movies = select_movies(user_movies=user_movies, k_percentage=0.10, movies_list=movies_list, strategy = 'greedy')
...
print("\n", "#"*100, "\n")
print("NN Gender Inference Accuracy before obfuscation:", success_original/total_num_users)
...
print("NN Gender Inference Accuracy after obfuscation:", success_obfuscated/total_num_users)
print("\n", "#"*100, "\n")
